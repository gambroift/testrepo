...
def get_pie_chart(entered_site):
                                    ...
                                    if entered_site == 'ALL':
                                        ...
                                        ones=np.ones(filtered_df.shape[0])
                                        pd.options.mode.chained_assignment = None  # default='warn'
                                        filtered_df['ones']=ones.tolist()
                                        fig = px.pie(filtered_df, values='ones', 
                                        names='class', 
...
def get_pie_chart(entered_site,slide):
                                    ...
                                    if entered_site == 'ALL':
                                        ...
                                        double_filtered_df=filtered_df[filtered_df['Launch Site']==entered_site]
                                        fig = px.scatter(double_filtered_df, x='Payload Mass (kg)', 
